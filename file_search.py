...
class file_parse_engine: 
    ...
    def remove_stopwords(self, text:str):
        ...
        filtered_words = [word for word in word_tokens if word.lower() not in self.stop_words]

        return filtered_words

    def generate_graph_source(self, text:str):
        # clean up 
        discovered_tokens:list = self.remove_stopwords(text.lower())
...
class file_detail:
    ...
    def tokenize_text(self):
        self.word_token_summary = self.file_parse_engine.generate_graph_source(text=self.text.lower())
    ...
    def encode_for_json(self):
        return {
            ...
            "token_info": dict(self.word_token_summary) # convert to dictionary
        }
